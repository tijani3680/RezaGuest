...
public class ShahrivarVM extends ViewModel {
    ...
    public MutableLiveData<List<ReservSuites>> getReservSuiteLiveData(){
        ...
        Repository.INSTANCE.callRequest(ApiService.client.getClient().getReservShahrivar(), SingletonDisposable.getInstance(), new Repository.Unit() {
            @Override
    ...
    public void saveReserv(String fullName, String phone, String customerId, int nafaratAvaliyeh, int nafaratMazad, int finalCoast, int coastReceived,
        ...
        Repository.INSTANCE.callRequest(ApiService.client.getClient().sendReservInformationShahrivar(fullName,phone, customerId,nafaratAvaliyeh,nafaratMazad,finalCoast,coastReceived,numberFish,reservistPerson, resSuite1, resSuite2, resSuite3,
    ...
    public MutableLiveData<List<ReservInformation>> getAllReserv(){
        ...
        Repository.INSTANCE.callRequest(ApiService.client.getClient().getAllReservShahrivar(), SingletonDisposable.getInstance(), new Repository.Unit() {
            @Override
            public void call(Object object) {
    ...
    public void getDetailsReserv(String id){
        ...
        Repository.INSTANCE.callRequest(ApiService.client.getClient().getDetailsReservShahrivar(id), SingletonDisposable.getInstance(), new Repository.Unit() {
            @Override
            public void call(Object object) {
    ...
    public void updateCoastReceived(String id,String money){
        ...
        Repository.INSTANCE.callRequest(ApiService.client.getClient().updateCoastReceivedShahrivar(id, money), SingletonDisposable.getInstance(), new Repository.Unit() {
            @Override
            public void call(Object object) {
    ...
    public void deleteReservCustomer(String id){
        ...
        Repository.INSTANCE.callRequest(ApiService.client.getClient().deleteReservCustomerShahrivar(id), SingletonDisposable.getInstance(), new Repository.Unit() {
            @Override
            public void call(Object object) {
