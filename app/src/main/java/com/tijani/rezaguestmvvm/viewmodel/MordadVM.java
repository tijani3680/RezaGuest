...
public class MordadVM  extends ViewModel {
    ...
    public MutableLiveData<List<ReservSuites>> getReservSuiteLiveData(){
        ...
        Repository.INSTANCE.callRequest(ApiService.client.getClient().getReservMordad(), SingletonDisposable.getInstance(), new Repository.Unit() {
            @Override
    ...
    public void saveReserv(String fullName, String phone, String customerId, int nafaratAvaliyeh, int nafaratMazad, int finalCoast, int coastReceived,
        ...
        Repository.INSTANCE.callRequest(ApiService.client.getClient().sendReservInformationMordad(fullName,phone, customerId,nafaratAvaliyeh,nafaratMazad,finalCoast,coastReceived,numberFish,reservistPerson, resSuite1, resSuite2, resSuite3,
    ...
    public MutableLiveData<List<ReservInformation>> getAllReserv(){
        ...
        Repository.INSTANCE.callRequest(ApiService.client.getClient().getAllReservMordad(), SingletonDisposable.getInstance(), new Repository.Unit() {
            @Override
            public void call(Object object) {
    ...
    public void getDetailsReserv(String id){
        ...
        Repository.INSTANCE.callRequest(ApiService.client.getClient().getDetailsReservMordad(id), SingletonDisposable.getInstance(), new Repository.Unit() {
            @Override
            public void call(Object object) {
    ...
    public void updateCoastReceived(String id,String money){
        ...
        Repository.INSTANCE.callRequest(ApiService.client.getClient().updateCoastReceivedMordad(id, money), SingletonDisposable.getInstance(), new Repository.Unit() {
            @Override
            public void call(Object object) {
    ...
    public void deleteReservCustomer(String id){
        deleteReservCustomerLiveData = new MutableLiveData<>();
            Repository.INSTANCE.callRequest(ApiService.client.getClient().deleteReservCustomerMordad(id), SingletonDisposable.getInstance(), new Repository.Unit() {
            @Override
            public void call(Object object) {
