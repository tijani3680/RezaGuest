...
import com.tijani.rezaguestmvvm.databinding.FragmentSendInformationFarvardinBinding;
import com.tijani.rezaguestmvvm.databinding.FragmentSendInformationOrdibeheshtBinding;
...
public class FragmentSendInformationOrdibehesht extends Fragment {
    FragmentSendInformationOrdibeheshtBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_send_information_ordibehesht,container,false);
    ...
    private String parcReservDays(List<Integer> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            String dey = MyUtils.number2persian(String.valueOf(list.get(i) + 1)) + " " + "اردیبهشت   ";
    ...
    private void findViews(FragmentSendInformationOrdibeheshtBinding binding) {
    ...
    private void sendData(String fullName, String phone, String customerId, int nafaratAvaliyeh, int nafaratMazad, int finalCoast, int coastReceived,
        ...
        OrdibeheshtVM viewModel = new ViewModelProvider(requireActivity()).get(OrdibeheshtVM.class);
