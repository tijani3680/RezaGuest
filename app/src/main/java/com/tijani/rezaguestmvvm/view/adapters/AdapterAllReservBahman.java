...
import com.tijani.rezaguestmvvm.databinding.ItemRecyclerBahmanReservationBinding;
...
public class AdapterAllReservBahman extends RecyclerView.Adapter<AdapterAllReservBahman.ReservInformationViewHolder> {
    private Context context;
    private List<ReservInformation> reservInformationList;
    private OnClickListener listener;

    public AdapterAllReservBahman(Context context, List<ReservInformation> reservInformationList, OnClickListener listener) {
    ...
    public ReservInformationViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemRecyclerBahmanReservationBinding binding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.item_recycler_bahman_reservation, parent, false);
    ...
    public class ReservInformationViewHolder extends RecyclerView.ViewHolder {
        ItemRecyclerBahmanReservationBinding binding;
        ImageView imgArrow;


        public ReservInformationViewHolder(@NonNull ItemRecyclerBahmanReservationBinding binding) {
