...
public class FragmentFarvardinReservation extends Fragment implements AdapterAllReservFarvardin.OnClickListener {
    FragmentFarvardinReservationBinding binding;
    private RecyclerView recyclerView;
    private AdapterAllReservFarvardin adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_farvardin_reservation, container, false);
        recyclerView = binding.rclFragmentFarvardinReservation;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        MutableLiveData<List<ReservInformation>> liveData = new ViewModelProvider(requireActivity()).get(FarvardinVM.class).getAllReserv();
        liveData.observe(requireActivity(), new Observer<List<ReservInformation>>() {
            ...
            public void onChanged(List<ReservInformation> reservInformations) {
                ...
                if (reservInformations.isEmpty()) {
                    ...
                    adapter = new AdapterAllReservFarvardin(getContext(), reservInformations,FragmentFarvardinReservation.this::arrowItemOnClick);
    ...
    public void arrowItemOnClick(ReservInformation reservInformation) {
        ...
        Navigation.findNavController(recyclerView).navigate(R.id.action_fragmentReservation_to_fragmentDetailsFarvardin,bundle);
