...
import com.tijani.rezaguestmvvm.databinding.FragmentOrdibeheshtBinding;
...
public class FragmentOrdibehesht extends Fragment {
    FragmentOrdibeheshtBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding  = DataBindingUtil.inflate(inflater,R.layout.fragment_ordibehesht,container,false);

        imgBack = binding.imgFragmentFarvardinImgBack;
        relBtnConfirmAndCancel = binding.relativeFragmentFarvardinConfirmOrCancel;
        btnConfirm = binding.btnFragmentFarvardinConfirm;
        btnCancel = binding.btnFragmentFarvardinCancel;
        gridLayoutS1 = binding.gridLayoutDaysFarvardinS1;
        gridLayoutS2 = binding.gridLayoutDaysFarvardinS2;
        gridLayoutS3 = binding.gridLayoutDaysFarvardinS3;
        gridLayoutS4 = binding.gridLayoutDaysFarvardinS4;
        gridLayoutS5 = binding.gridLayoutDaysFarvardinS5;
        gridLayoutS6 = binding.gridLayoutDaysFarvardinS6;
        gridLayoutS7 = binding.gridLayoutDaysFarvardinS7;
        gridLayoutS8 = binding.gridLayoutDaysFarvardinS8;
        gridLayoutS9 = binding.gridLayoutDaysFarvardinS9;
        gridLayoutS10 = binding.gridLayoutDaysFarvardinS10;
        gridLayoutS11 = binding.gridLayoutDaysFarvardinS11;
        gridLayoutS12 = binding.gridLayoutDaysFarvardinS12;
        prg=binding.progressbarFragmentFarvardin;
    ...
    private void goToFragmentSendInformation() {
        if (!(idGrid_selected_s1.isEmpty()) || !(idGrid_selected_s2.isEmpty()) || !(idGrid_selected_s3.isEmpty()) || !(idGrid_selected_s4.isEmpty()) || !(idGrid_selected_s5.isEmpty()) || !(idGrid_selected_s6.isEmpty()) || !(idGrid_selected_s7.isEmpty()) || !(idGrid_selected_s8.isEmpty()) || !(idGrid_selected_s9.isEmpty()) || !(idGrid_selected_s10.isEmpty()) || !(idGrid_selected_s11.isEmpty()) || !(idGrid_selected_s12.isEmpty())) {
            ...
            Navigation.findNavController(btnConfirm).navigate(R.id.action_fragmentOrdibehesht_to_fragmentSendInformationOrdibehesht, bundle);
        ...
        checkActivateSuites();
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        MutableLiveData<List<ReservSuites>> liveData = new ViewModelProvider(requireActivity()).get(OrdibeheshtVM.class).getReservSuiteLiveData();
