...
public class FragmentSendInformationKhordad extends Fragment {
    FragmentSendInformationKhordadBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_send_information_khordad,container,false);
        findViews(binding);
    ...
    private String parcReservDays(List<Integer> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            String dey = MyUtils.number2persian(String.valueOf(list.get(i) + 1)) + " " + "خرداد   ";
    ...
    private void findViews(FragmentSendInformationKhordadBinding binding) {
    ...
    private void sendData(String fullName, String phone, String customerId, int nafaratAvaliyeh, int nafaratMazad, int finalCoast, int coastReceived,
        ...
        KhordadVM viewModel = new ViewModelProvider(requireActivity()).get(KhordadVM.class);
