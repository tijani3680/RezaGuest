...
import com.tijani.rezaguestmvvm.databinding.FragmentShahrivarReservationBinding;
...
import com.tijani.rezaguestmvvm.view.adapters.AdapterAllReservShahrivar;
import com.tijani.rezaguestmvvm.viewmodel.MordadVM;
import com.tijani.rezaguestmvvm.viewmodel.ShahrivarVM;

import java.util.List;

public class FragmentShahrivarReservation extends Fragment implements AdapterAllReservShahrivar.OnClickListener {
    FragmentShahrivarReservationBinding binding;
    private RecyclerView recyclerView;
    private AdapterAllReservShahrivar adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_shahrivar_reservation,container,false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        MutableLiveData<List<ReservInformation>> liveData = new ViewModelProvider(requireActivity()).get(ShahrivarVM.class).getAllReserv();
        liveData.observe(requireActivity(), new Observer<List<ReservInformation>>() {
            ...
            public void onChanged(List<ReservInformation> reservInformations) {
                ...
                if (reservInformations.isEmpty()){
                    ...
                    adapter = new AdapterAllReservShahrivar(getContext(),reservInformations,FragmentShahrivarReservation.this::arrowItemOnClick);
    ...
    public void arrowItemOnClick(ReservInformation reservInformation) {
        ...
        Navigation.findNavController(recyclerView).navigate(R.id.action_fragmentReservation_to_fragmentDetailsShahrivar,bundle);
