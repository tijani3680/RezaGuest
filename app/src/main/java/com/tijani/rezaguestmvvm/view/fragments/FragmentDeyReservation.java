...
import com.tijani.rezaguestmvvm.databinding.FragmentDeyReservationBinding;
import com.tijani.rezaguestmvvm.model.ReservInformation;
import com.tijani.rezaguestmvvm.view.adapters.AdapterAllReservDey;
...
import com.tijani.rezaguestmvvm.viewmodel.DeyVM;
import com.tijani.rezaguestmvvm.viewmodel.MordadVM;

import java.util.List;

public class FragmentDeyReservation extends Fragment implements AdapterAllReservDey.OnClickListener {
    FragmentDeyReservationBinding binding;
    private RecyclerView recyclerView;
    private AdapterAllReservDey adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_dey_reservation,container,false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        MutableLiveData<List<ReservInformation>> liveData = new ViewModelProvider(requireActivity()).get(DeyVM.class).getAllReserv();
        liveData.observe(requireActivity(), new Observer<List<ReservInformation>>() {
            ...
            public void onChanged(List<ReservInformation> reservInformations) {
                ...
                if (reservInformations.isEmpty()){
                    ...
                    adapter = new AdapterAllReservDey(getContext(),reservInformations,FragmentDeyReservation.this::arrowItemOnClick);
    ...
    public void arrowItemOnClick(ReservInformation reservInformation) {
        ...
        Navigation.findNavController(recyclerView).navigate(R.id.action_fragmentReservation_to_fragmentDetailsDey,bundle);
