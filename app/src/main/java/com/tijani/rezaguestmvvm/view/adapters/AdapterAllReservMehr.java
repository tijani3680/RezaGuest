...
import com.tijani.rezaguestmvvm.databinding.ItemRecyclerMehrReservationBinding;
import com.tijani.rezaguestmvvm.model.ReservInformation;

import java.util.List;

public class AdapterAllReservMehr extends RecyclerView.Adapter<AdapterAllReservMehr.ReservInformationViewHolder> {
    private Context context;
    private List<ReservInformation> reservInformationList;
    private OnClickListener listener;

    public AdapterAllReservMehr(Context context, List<ReservInformation> reservInformationList, OnClickListener listener) {
    ...
    public ReservInformationViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemRecyclerMehrReservationBinding binding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.item_recycler_mehr_reservation, parent, false);
    ...
    public class ReservInformationViewHolder extends RecyclerView.ViewHolder {
        ItemRecyclerMehrReservationBinding binding;
        ImageView imgArrow;


        public ReservInformationViewHolder(@NonNull ItemRecyclerMehrReservationBinding binding) {
