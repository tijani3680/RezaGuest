...
import com.tijani.rezaguestmvvm.databinding.FragmentEsfandReservationBinding;
...
import com.tijani.rezaguestmvvm.view.adapters.AdapterAllReservEsfand;
...
import com.tijani.rezaguestmvvm.viewmodel.EsfandVM;
import com.tijani.rezaguestmvvm.viewmodel.MordadVM;

import java.util.List;

public class FragmentEsfandReservation extends Fragment implements AdapterAllReservEsfand.OnClickListener {
    FragmentEsfandReservationBinding binding;
    private RecyclerView recyclerView;
    private AdapterAllReservEsfand adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_esfand_reservation,container,false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        MutableLiveData<List<ReservInformation>> liveData = new ViewModelProvider(requireActivity()).get(EsfandVM.class).getAllReserv();
        liveData.observe(requireActivity(), new Observer<List<ReservInformation>>() {
            ...
            public void onChanged(List<ReservInformation> reservInformations) {
                ...
                if (reservInformations.isEmpty()){
                    ...
                    adapter = new AdapterAllReservEsfand(getContext(),reservInformations,FragmentEsfandReservation.this::arrowItemOnClick);
    ...
    public void arrowItemOnClick(ReservInformation reservInformation) {
        ...
        Navigation.findNavController(recyclerView).navigate(R.id.action_fragmentReservation_to_fragmentDetailsEsfand,bundle);
