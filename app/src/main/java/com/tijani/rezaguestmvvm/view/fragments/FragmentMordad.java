...
import com.tijani.rezaguestmvvm.databinding.FragmentMordadBinding;
...
public class FragmentMordad extends Fragment {
    FragmentMordadBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_mordad,container,false);
    ...
    private void goToFragmentSendInformation() {
        if (!(idGrid_selected_s1.isEmpty()) || !(idGrid_selected_s2.isEmpty()) || !(idGrid_selected_s3.isEmpty()) || !(idGrid_selected_s4.isEmpty()) || !(idGrid_selected_s5.isEmpty()) || !(idGrid_selected_s6.isEmpty()) || !(idGrid_selected_s7.isEmpty()) || !(idGrid_selected_s8.isEmpty()) || !(idGrid_selected_s9.isEmpty()) || !(idGrid_selected_s10.isEmpty()) || !(idGrid_selected_s11.isEmpty()) || !(idGrid_selected_s12.isEmpty())) {
            ...
            Navigation.findNavController(btnConfirm).navigate(R.id.action_fragmentMordad_to_fragmentSendInformationMordad, bundle);
    ...
    private void initReservDays() {
        ...
        checkActivateSuites();
                ...
                handler.post(new Runnable() {
                    @Override
                    public void run() {
                        MutableLiveData<List<ReservSuites>> liveData = new ViewModelProvider(requireActivity()).get(MordadVM.class).getReservSuiteLiveData();
