...
import com.tijani.rezaguestmvvm.databinding.FragmentSendInformationAzarBinding;
...
public class FragmentSendInformationAzar extends Fragment {
    FragmentSendInformationAzarBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_send_information_azar,container,false);
        findViews(binding);
    ...
    private String parcReservDays(List<Integer> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            String dey = MyUtils.number2persian(String.valueOf(list.get(i) + 1)) + " " + "آذر   ";
    ...
    private void findViews(FragmentSendInformationAzarBinding binding) {
    ...
    private void sendData(String fullName, String phone, String customerId, int nafaratAvaliyeh, int nafaratMazad, int finalCoast, int coastReceived,
        ...
        AzarVM viewModel = new ViewModelProvider(requireActivity()).get(AzarVM.class);
