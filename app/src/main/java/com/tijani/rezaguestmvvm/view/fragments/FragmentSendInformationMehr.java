...
import com.tijani.rezaguestmvvm.databinding.FragmentSendInformationMehrBinding;
...
public class FragmentSendInformationMehr extends Fragment {
    FragmentSendInformationMehrBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_send_information_mehr,container,false);
        findViews(binding);
    ...
    private String parcReservDays(List<Integer> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            String dey = MyUtils.number2persian(String.valueOf(list.get(i) + 1)) + " " + "مهر   ";
    ...
    private void findViews(FragmentSendInformationMehrBinding binding) {
    ...
    private void sendData(String fullName, String phone, String customerId, int nafaratAvaliyeh, int nafaratMazad, int finalCoast, int coastReceived,
        ...
        MehrVM viewModel = new ViewModelProvider(requireActivity()).get(MehrVM.class);
