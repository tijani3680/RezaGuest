...
import com.tijani.rezaguestmvvm.databinding.FragmentTirBinding;
...
public class FragmentTir extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_tir,container,false);
    ...
    private void goToFragmentSendInformation() {
        if (!(idGrid_selected_s1.isEmpty()) || !(idGrid_selected_s2.isEmpty()) || !(idGrid_selected_s3.isEmpty()) || !(idGrid_selected_s4.isEmpty()) || !(idGrid_selected_s5.isEmpty()) || !(idGrid_selected_s6.isEmpty()) || !(idGrid_selected_s7.isEmpty()) || !(idGrid_selected_s8.isEmpty()) || !(idGrid_selected_s9.isEmpty()) || !(idGrid_selected_s10.isEmpty()) || !(idGrid_selected_s11.isEmpty()) || !(idGrid_selected_s12.isEmpty())) {
            ...
            Navigation.findNavController(btnConfirm).navigate(R.id.action_fragmentTir_to_fragmentSendInformationTir, bundle);
        ...
        checkActivateSuites();
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        MutableLiveData<List<ReservSuites>> liveData = new ViewModelProvider(requireActivity()).get(TirVM.class).getReservSuiteLiveData();
