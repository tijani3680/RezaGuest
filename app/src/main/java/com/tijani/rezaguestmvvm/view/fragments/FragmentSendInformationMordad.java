...
import com.tijani.rezaguestmvvm.databinding.FragmentSendInformationMordadBinding;
...
public class FragmentSendInformationMordad extends Fragment {
    FragmentSendInformationMordadBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_send_information_mordad,container,false);
        findViews(binding);
    ...
    private String parcReservDays(List<Integer> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            String dey = MyUtils.number2persian(String.valueOf(list.get(i) + 1)) + " " + "مرداد   ";
    ...
    private void findViews(FragmentSendInformationMordadBinding binding) {
