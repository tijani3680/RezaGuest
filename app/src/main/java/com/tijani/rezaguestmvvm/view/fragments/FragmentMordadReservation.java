...
import com.tijani.rezaguestmvvm.databinding.FragmentMordadReservationBinding;
...
public class FragmentMordadReservation extends Fragment implements AdapterAllReservMordad.OnClickListener {
    FragmentMordadReservationBinding binding;
    private RecyclerView recyclerView;
    private AdapterAllReservMordad adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_mordad_reservation,container,false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        MutableLiveData<List<ReservInformation>> liveData = new ViewModelProvider(requireActivity()).get(MordadVM.class).getAllReserv();
        liveData.observe(requireActivity(), new Observer<List<ReservInformation>>() {
            ...
            public void onChanged(List<ReservInformation> reservInformations) {
                ...
                if (reservInformations.isEmpty()){
                    ...
                    adapter = new AdapterAllReservMordad(getContext(),reservInformations,FragmentMordadReservation.this::arrowItemOnClick);
    ...
    public void arrowItemOnClick(ReservInformation reservInformation) {
        ...
        Navigation.findNavController(recyclerView).navigate(R.id.action_fragmentReservation_to_fragmentDetailsMordad,bundle);
