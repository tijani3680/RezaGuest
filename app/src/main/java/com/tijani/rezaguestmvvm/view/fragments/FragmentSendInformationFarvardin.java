...
public class FragmentSendInformationFarvardin extends Fragment {
    FragmentSendInformationFarvardinBinding binding;
  ...
  private Boolean checkPrice = false;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_send_information_farvardin, container, false);
    ...
    private String parcReservDays(List<Integer> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            String dey = MyUtils.number2persian(String.valueOf(list.get(i) + 1)) + " " + "فروردین   ";
    ...
    private void findViews(FragmentSendInformationFarvardinBinding binding) {
