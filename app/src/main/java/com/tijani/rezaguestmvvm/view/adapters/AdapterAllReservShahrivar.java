...
import com.tijani.rezaguestmvvm.databinding.ItemRecyclerShahrivarReservationBinding;
import com.tijani.rezaguestmvvm.model.ReservInformation;

import java.util.List;

public class AdapterAllReservShahrivar extends RecyclerView.Adapter<AdapterAllReservShahrivar.ReservInformationViewHolder> {
    private Context context;
    private List<ReservInformation> reservInformationList;
    private OnClickListener listener;

    public AdapterAllReservShahrivar(Context context, List<ReservInformation> reservInformationList, OnClickListener listener) {
    ...
    public ReservInformationViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemRecyclerShahrivarReservationBinding binding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.item_recycler_shahrivar_reservation, parent, false);
    ...
    public class ReservInformationViewHolder extends RecyclerView.ViewHolder {
        ItemRecyclerShahrivarReservationBinding binding;
        ImageView imgArrow;


        public ReservInformationViewHolder(@NonNull ItemRecyclerShahrivarReservationBinding binding) {
