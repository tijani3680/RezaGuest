...
import com.tijani.rezaguestmvvm.databinding.FragmentSendInformationEsfandBinding;
import com.tijani.rezaguestmvvm.databinding.FragmentSendInformationShahrivarBinding;
...
public class FragmentSendInformationEsfand extends Fragment {
    FragmentSendInformationEsfandBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_send_information_esfand,container,false);
        findViews(binding);
    ...
    private String parcReservDays(List<Integer> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            String dey = MyUtils.number2persian(String.valueOf(list.get(i) + 1)) + " " + "اسفند   ";
    ...
    private void findViews(FragmentSendInformationEsfandBinding binding) {
    ...
    private void sendData(String fullName, String phone, String customerId, int nafaratAvaliyeh, int nafaratMazad, int finalCoast, int coastReceived,
        ...
        EsfandVM viewModel = new ViewModelProvider(requireActivity()).get(EsfandVM.class);
