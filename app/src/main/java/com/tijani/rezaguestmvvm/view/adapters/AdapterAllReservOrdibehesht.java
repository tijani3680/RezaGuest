...
import com.tijani.rezaguestmvvm.databinding.ItemRecyclerOrdibeheshtReservationBinding;
import com.tijani.rezaguestmvvm.model.ReservInformation;

import java.util.List;

public class AdapterAllReservOrdibehesht extends RecyclerView.Adapter<AdapterAllReservOrdibehesht.ReservInformationViewHolder> {

    private Context context;
    private List<ReservInformation> reservInformationList;
    private AdapterAllReservFarvardin.OnClickListener listener;


    public AdapterAllReservOrdibehesht(Context context, List<ReservInformation> reservInformationList, AdapterAllReservFarvardin.OnClickListener listener) {
    ...
    public ReservInformationViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemRecyclerOrdibeheshtReservationBinding binding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.item_recycler_ordibehesht_reservation, parent, false);
    ...
    public class ReservInformationViewHolder extends RecyclerView.ViewHolder {
        ItemRecyclerOrdibeheshtReservationBinding binding;
        ImageView imgArrow;

        public ReservInformationViewHolder(@NonNull ItemRecyclerOrdibeheshtReservationBinding binding) {
