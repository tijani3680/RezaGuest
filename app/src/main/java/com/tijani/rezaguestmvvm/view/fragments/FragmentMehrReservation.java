...
import com.tijani.rezaguestmvvm.databinding.FragmentMehrReservationBinding;
...
import com.tijani.rezaguestmvvm.view.adapters.AdapterAllReservMehr;
import com.tijani.rezaguestmvvm.view.adapters.AdapterAllReservMordad;
import com.tijani.rezaguestmvvm.viewmodel.MehrVM;
import com.tijani.rezaguestmvvm.viewmodel.MordadVM;

import java.util.List;

public class FragmentMehrReservation extends Fragment implements AdapterAllReservMehr.OnClickListener {
    FragmentMehrReservationBinding binding;
    private RecyclerView recyclerView;
    private AdapterAllReservMehr adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_mehr_reservation,container,false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        MutableLiveData<List<ReservInformation>> liveData = new ViewModelProvider(requireActivity()).get(MehrVM.class).getAllReserv();
        liveData.observe(requireActivity(), new Observer<List<ReservInformation>>() {
            ...
            public void onChanged(List<ReservInformation> reservInformations) {
                ...
                if (reservInformations.isEmpty()){
                    ...
                    adapter = new AdapterAllReservMehr(getContext(),reservInformations,FragmentMehrReservation.this::arrowItemOnClick);
    ...
    public void arrowItemOnClick(ReservInformation reservInformation) {
        ...
        Navigation.findNavController(recyclerView).navigate(R.id.action_fragmentReservation_to_fragmentDetailsMehr,bundle);
