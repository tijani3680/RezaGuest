...
import com.tijani.rezaguestmvvm.databinding.FragmentSendInformationBahmanBinding;
...
public class FragmentSendInformationBahman extends Fragment {
    FragmentSendInformationBahmanBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_send_information_bahman,container,false);
        findViews(binding);
    ...
    private String parcReservDays(List<Integer> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            String dey = MyUtils.number2persian(String.valueOf(list.get(i) + 1)) + " " + "بهمن   ";
    ...
    private void findViews(FragmentSendInformationBahmanBinding binding) {
    ...
    private void sendData(String fullName, String phone, String customerId, int nafaratAvaliyeh, int nafaratMazad, int finalCoast, int coastReceived,
        ...
        BahmanVM viewModel = new ViewModelProvider(requireActivity()).get(BahmanVM.class);
