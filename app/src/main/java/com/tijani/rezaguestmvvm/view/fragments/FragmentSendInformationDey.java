...
import com.tijani.rezaguestmvvm.databinding.FragmentSendInformationDeyBinding;
...
public class FragmentSendInformationDey extends Fragment {
    FragmentSendInformationDeyBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_send_information_dey,container,false);
        findViews(binding);
    ...
    private String parcReservDays(List<Integer> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            String dey = MyUtils.number2persian(String.valueOf(list.get(i) + 1)) + " " + "دی   ";
    ...
    private void findViews(FragmentSendInformationDeyBinding binding) {
    ...
    private void sendData(String fullName, String phone, String customerId, int nafaratAvaliyeh, int nafaratMazad, int finalCoast, int coastReceived,
        ...
        DeyVM viewModel = new ViewModelProvider(requireActivity()).get(DeyVM.class);
